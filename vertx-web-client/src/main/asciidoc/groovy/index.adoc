...
You can set a timeout for a specific http request using `link:../../apidocs/io/vertx/webclient/HttpRequest.html#timeout-long-[timeout]`.
...
WARNING: responses are fully buffered, use `link:../../apidocs/io/vertx/webclient/BodyCodec.html#pipe-io.vertx.core.streams.WriteStream-[BodyCodec.pipe]`
