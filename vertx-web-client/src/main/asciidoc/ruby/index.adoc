...
client.get(8080, "myserver.mycompany.com", "/some-uri").as(VertxWebClient::BodyCodec.json_object()).send() { |ar_err,ar|
  if (ar_err == nil)
    response = ar
...
----
require 'vertx-web-client/body_codec'
client.get(8080, "myserver.mycompany.com", "/some-uri").as(VertxWebClient::BodyCodec.json(Java::ExamplesWebClientExamples::User::class)).send() { |ar_err,ar|
  if (ar_err == nil)
    response = ar
...
----
require 'vertx-web-client/body_codec'
client.get(8080, "myserver.mycompany.com", "/some-uri").as(VertxWebClient::BodyCodec.pipe(writeStream)).send() { |ar_err,ar|
  if (ar_err == nil)
...
----
require 'vertx-web-client/body_codec'
client.get(8080, "myserver.mycompany.com", "/some-uri").as(VertxWebClient::BodyCodec.none()).send() { |ar_err,ar|
  if (ar_err == nil)
