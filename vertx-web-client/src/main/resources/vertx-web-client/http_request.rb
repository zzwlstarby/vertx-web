...
module VertxWebClient
  ...
  class HttpRequest
    ...
    # @param [::VertxWebClient::BodyCodec] responseCodec the response codec
    ...
    def as(responseCodec=nil)
      if responseCodec.class.method_defined?(:j_del) && !block_given?
        return ::Vertx::Util::Utils.safe_create(@j_del.java_method(:as, [Java::IoVertxWebclient::BodyCodec.java_class]).call(responseCodec.j_del),::VertxWebClient::HttpRequest, nil)
      end
