...
A `link:../../groovydoc/io/vertx/groovy/ext/web/Router.html[Router]` is one of the core concepts of Vert.x-Web. It's an object which maintains zero or more
`link:../../groovydoc/io/vertx/groovy/ext/web/Route.html[Routes]` .
...
The object that gets passed into the handler is a `link:../../groovydoc/io/vertx/groovy/ext/web/RoutingContext.html[RoutingContext]` - this contains
...
to `link:../../groovydoc/io/vertx/groovy/ext/web/Router.html#accept(io.vertx.core.http.HttpServerRequest)[accept]`.
...
of `link:../../groovydoc/io/vertx/groovy/ext/web/RoutingContext.html[RoutingContext]`.

If you don't end the response in your handler, you should call `link:../../groovydoc/io/vertx/groovy/ext/web/RoutingContext.html#next()[next]` so another
matching route can handle the request (if any).

You don't have to call `link:../../groovydoc/io/vertx/groovy/ext/web/RoutingContext.html#next()[next]` before the handler has finished executing.
...
You set a blocking handler on a route with `link:../../groovydoc/io/vertx/groovy/ext/web/Route.html#blockingHandler(io.vertx.core.Handler)[blockingHandler]`.
Here's an example:
...
def route = router.route(HttpMethod.POST, "/catalogue/products/:productype/:productid/")
...
If you want a route to only match for a specific HTTP method you can use `link:../../groovydoc/io/vertx/groovy/ext/web/Route.html#method(io.vertx.core.http.HttpMethod)[method]`
...
If you want to route for a specific HTTP method you can also use the methods such as `link:../../groovydoc/io/vertx/groovy/ext/web/Router.html#get()[get]`,
`link:../../groovydoc/io/vertx/groovy/ext/web/Router.html#post()[post]` and `link:../../groovydoc/io/vertx/groovy/ext/web/Router.html#put()[put]` named after the HTTP
...
If you want to specify a route will match for more than HTTP method you can call `link:../../groovydoc/io/vertx/groovy/ext/web/Route.html#method(io.vertx.core.http.HttpMethod)[method]`
multiple times:
...
If the handler subsequently calls `link:../../groovydoc/io/vertx/groovy/ext/web/RoutingContext.html#next()[next]` the handler for the next
...
If you want to override the default ordering for routes, you can do so using `link:../../groovydoc/io/vertx/groovy/ext/web/Route.html#order(int)[order]`,
...
You can also specify that a route is handled last, with `link:../../groovydoc/io/vertx/groovy/ext/web/Route.html#last()[last]`

== Routing based on MIME type of request

You can specify that a route will match against matching request MIME types using `link:../../groovydoc/io/vertx/groovy/ext/web/Route.html#consumes(java.lang.String)[consumes]`.

In this case, the request will contain a `content-type` header specifying the MIME type of the request body.
This will be matched against the value specified in `link:../../groovydoc/io/vertx/groovy/ext/web/Route.html#consumes(java.lang.String)[consumes]`.
...
By using `link:../../groovydoc/io/vertx/groovy/ext/web/Route.html#produces(java.lang.String)[produces]` you define which MIME type(s) the route produces, e.g. the
...
`link:../../groovydoc/io/vertx/groovy/ext/web/RoutingContext.html#getAcceptableContentType()[getAcceptableContentType]` to find out the actual MIME type that
was accepted.
...
You can disable a route with `link:../../groovydoc/io/vertx/groovy/ext/web/Route.html#disable()[disable]`. A disabled route will be ignored when matching.

You can re-enable a disabled route with `link:../../groovydoc/io/vertx/groovy/ext/web/Route.html#enable()[enable]`

== Context data

You can use the context data in the `link:../../groovydoc/io/vertx/groovy/ext/web/RoutingContext.html[RoutingContext]` to maintain any data that you
...
You can use the `link:../../groovydoc/io/vertx/groovy/ext/web/RoutingContext.html#put(java.lang.String,%20java.lang.Object)[put]` to put any object, and
`link:../../groovydoc/io/vertx/groovy/ext/web/RoutingContext.html#get(java.lang.String)[get]` to retrieve any object from the context data.
...
def route = router.get("/localized").handler({ rc ->
  ...
  rc.acceptableLocales().each { locale ->
    return
  }
...
The main method `link:../../groovydoc/io/vertx/groovy/ext/web/RoutingContext.html#acceptableLocales()[acceptableLocales]` will return the ordered list of locales the
user understands, if you're only interested in the user prefered locale then the helper:
`link:../../groovydoc/io/vertx/groovy/ext/web/RoutingContext.html#preferredLocale()[preferredLocale]` will return the 1st element of the list or `null` if no
...
`link:../../groovydoc/io/vertx/groovy/ext/web/RoutingContext.html#fail(int)[fail]` specifying an HTTP status code to deliberately signal a failure.
...
The `link:../../groovydoc/io/vertx/groovy/ext/web/handler/BodyHandler.html[BodyHandler]` allows you to retrieve request bodies, limit body sizes and handle
file uploads.
...
If you know the request body is JSON, then you can use `link:../../groovydoc/io/vertx/groovy/ext/web/RoutingContext.html#getBodyAsJson()[getBodyAsJson]`,
if you know it's a string you can use `link:../../groovydoc/io/vertx/groovy/ext/web/RoutingContext.html#getBodyAsString()[getBodyAsString]`, or to
retrieve it as a buffer use `link:../../groovydoc/io/vertx/groovy/ext/web/RoutingContext.html#getBody()[getBody]`.

=== Limiting body size

To limit the size of a request body, create the body handler then use `link:../../groovydoc/io/vertx/groovy/ext/web/handler/BodyHandler.html#setBodyLimit(long)[setBodyLimit]`
...
you can use disable it with `link:../../groovydoc/io/vertx/groovy/ext/web/handler/BodyHandler.html#setMergeFormAttributes(boolean)[setMergeFormAttributes]`.
...
context with `link:../../groovydoc/io/vertx/groovy/ext/web/RoutingContext.html#fileUploads()[fileUploads]`.
...
Each file upload is described by a `link:../../groovydoc/io/vertx/groovy/ext/web/FileUpload.html[FileUpload]` instance, which allows various properties
such as the name, file-name and size to be accessed.

== Handling cookies

Vert.x-Web has cookies support using the `link:../../groovydoc/io/vertx/groovy/ext/web/handler/CookieHandler.html[CookieHandler]`.
...
You use `link:../../groovydoc/io/vertx/groovy/ext/web/RoutingContext.html#getCookie(java.lang.String)[getCookie]` to retrieve
a cookie by name, or use `link:../../groovydoc/io/vertx/groovy/ext/web/RoutingContext.html#cookies()[cookies]` to retrieve the entire set.

To remove a cookie, use `link:../../groovydoc/io/vertx/groovy/ext/web/RoutingContext.html#removeCookie(java.lang.String)[removeCookie]`.

To add a cookie use `link:../../groovydoc/io/vertx/groovy/ext/web/RoutingContext.html#addCookie(io.vertx.ext.web.Cookie)[addCookie]`.
...
Cookies are described by instances of `link:../../groovydoc/io/vertx/groovy/ext/web/Cookie.html[Cookie]`. This allows you to retrieve the name,
...
To enable sessions in your application you must have a `link:../../groovydoc/io/vertx/groovy/ext/web/handler/SessionHandler.html[SessionHandler]`
...
`link:../../groovydoc/io/vertx/groovy/ext/web/sstore/LocalSessionStore.html#create(io.vertx.core.Vertx,%20java.lang.String,%20long)[LocalSessionStore.create]`.

Here are some examples of creating a `link:../../groovydoc/io/vertx/groovy/ext/web/sstore/LocalSessionStore.html[LocalSessionStore]`
...
Here are some examples of creating a `link:../../groovydoc/io/vertx/groovy/ext/web/sstore/ClusteredSessionStore.html[ClusteredSessionStore]`
...
You'll also need to include a `link:../../groovydoc/io/vertx/groovy/ext/web/handler/CookieHandler.html[CookieHandler]` as the session handler uses cookies to
...
In your handlers you can access the session instance with `link:../../groovydoc/io/vertx/groovy/ext/web/RoutingContext.html#session()[session]`.

You put data into the session with `link:../../groovydoc/io/vertx/groovy/ext/web/Session.html#put(java.lang.String,%20java.lang.Object)[put]`,
you get data from the session with `link:../../groovydoc/io/vertx/groovy/ext/web/Session.html#get(java.lang.String)[get]`, and you remove
data from the session with `link:../../groovydoc/io/vertx/groovy/ext/web/Session.html#remove(java.lang.String)[remove]`.

The keys for items in the session are always strings. The values can be any type for a local session store, and for
a clustered session store they can be any basic type, or `link:../../groovydoc/io/vertx/groovy/core/buffer/Buffer.html[Buffer]`, `JsonObject`,
...
You can manually destroy a session using `link:../../groovydoc/io/vertx/groovy/ext/web/Session.html#destroy()[destroy]`. This will remove the session
...
You can also use `link:../../groovydoc/io/vertx/groovy/ext/web/Session.html#setAccessed()[setAccessed]` to manually mark a session as accessed.
...
To create an auth handler you need an instance of `link:../../groovydoc/io/vertx/groovy/ext/auth/AuthProvider.html[AuthProvider]`. Auth provider is
...
import io.vertx.groovy.ext.web.sstore.LocalSessionStore
import io.vertx.groovy.ext.web.handler.SessionHandler
import io.vertx.groovy.ext.web.handler.BasicAuthHandler
...
If the auth handler has successfully authenticated and authorised the user it will inject a `link:../../groovydoc/io/vertx/groovy/ext/auth/User.html[User]`
object into the `link:../../groovydoc/io/vertx/groovy/ext/web/RoutingContext.html[RoutingContext]` so it's available in your handlers with:
`link:../../groovydoc/io/vertx/groovy/ext/web/RoutingContext.html#user()[user]`.
...
If you want to cause the user to be logged out you can call `link:../../groovydoc/io/vertx/groovy/ext/web/RoutingContext.html#clearUser()[clearUser]`
...
When the basic auth handler receives this information, it calls the configured `link:../../groovydoc/io/vertx/groovy/ext/auth/AuthProvider.html[AuthProvider]`
...
To use redirect auth you configure an instance of `link:../../groovydoc/io/vertx/groovy/ext/web/handler/RedirectAuthHandler.html[RedirectAuthHandler]` instead of a
basic auth handler.

You will also need to setup handlers to serve your actual login page, and a handler to handle the actual login itself.
To handle the login we provide a prebuilt handler `link:../../groovydoc/io/vertx/groovy/ext/web/handler/FormLoginHandler.html[FormLoginHandler]` for the purpose.
...
`link:../../groovydoc/io/vertx/groovy/ext/web/handler/StaticHandler.html[StaticHandler]`.
...
`link:../../groovydoc/io/vertx/groovy/ext/web/handler/StaticHandler.html#setMaxAgeSeconds(long)[setMaxAgeSeconds]` if required.
...
If handling of cache headers is not required, it can be disabled with `link:../../groovydoc/io/vertx/groovy/ext/web/handler/StaticHandler.html#setCachingEnabled(boolean)[setCachingEnabled]`.
...
`link:../../groovydoc/io/vertx/groovy/ext/web/handler/StaticHandler.html#setFilesReadOnly(boolean)[setFilesReadOnly]`.

To enable the maximum number of entries that can be cached in memory at any one time you can use
`link:../../groovydoc/io/vertx/groovy/ext/web/handler/StaticHandler.html#setMaxCacheSize(int)[setMaxCacheSize]`.

To configure the expiry time of cache entries you can use `link:../../groovydoc/io/vertx/groovy/ext/web/handler/StaticHandler.html#setCacheEntryTimeout(long)[setCacheEntryTimeout]`.
...
This can be configured with `link:../../groovydoc/io/vertx/groovy/ext/web/handler/StaticHandler.html#setIndexPage(java.lang.String)[setIndexPage]`.

=== Changing the web root

By default static resources will be served from the directory `webroot`. To configure this use
`link:../../groovydoc/io/vertx/groovy/ext/web/handler/StaticHandler.html#setWebRoot(java.lang.String)[setWebRoot]`.

=== Serving hidden files

By default the serve will serve hidden files (files starting with `.`).

If you do not want hidden files to be served you can configure it with `link:../../groovydoc/io/vertx/groovy/ext/web/handler/StaticHandler.html#setIncludeHidden(boolean)[setIncludeHidden]`.

=== Directory listing

The server can also perform directory listing. By default directory listing is disabled. To enabled it use
`link:../../groovydoc/io/vertx/groovy/ext/web/handler/StaticHandler.html#setDirectoryListing(boolean)[setDirectoryListing]`.
...
`link:../../groovydoc/io/vertx/groovy/ext/web/handler/StaticHandler.html#setDirectoryTemplate(java.lang.String)[setDirectoryTemplate]`.
...
Vert.x-Web includes a handler `link:../../groovydoc/io/vertx/groovy/ext/web/handler/CorsHandler.html[CorsHandler]` that handles the CORS protocol for you.
...
Template engines are described by `link:../../groovydoc/io/vertx/groovy/ext/web/templ/TemplateEngine.html[TemplateEngine]`. In order to render a template
`link:../../groovydoc/io/vertx/groovy/ext/web/templ/TemplateEngine.html#render(io.vertx.ext.web.RoutingContext,%20java.lang.String,%20io.vertx.core.Handler)[render]` is used.

The simplest way to use templates is not to call the template engine directly but to use the
`link:../../groovydoc/io/vertx/groovy/ext/web/handler/TemplateHandler.html[TemplateHandler]`.
...
The routing context `link:../../groovydoc/io/vertx/groovy/ext/web/RoutingContext.html[RoutingContext]` is available
...
Instead, the context `link:../../groovydoc/io/vertx/groovy/ext/web/RoutingContext.html#data()[data]` is available in the template.
...
The handler is `link:../../groovydoc/io/vertx/groovy/ext/web/handler/ErrorHandler.html[ErrorHandler]`. To use the error handler just set it as a
failure handler for any paths that you want covered.

== Request logger

Vert.x-Web includes a handler `link:../../groovydoc/io/vertx/groovy/ext/web/handler/LoggerHandler.html[LoggerHandler]` that you can use to log HTTP requests.
...
Vert.x-Web includes the handler `link:../../groovydoc/io/vertx/groovy/ext/web/handler/FaviconHandler.html[FaviconHandler]` especially for serving favicons.
...
This is configured using an instance of `link:../../groovydoc/io/vertx/groovy/ext/web/handler/TimeoutHandler.html[TimeoutHandler]`.
...
Vert.x provides an out of the box handler called `link:../../groovydoc/io/vertx/groovy/ext/web/handler/sockjs/SockJSHandler.html[SockJSHandler]` for
using SockJS in your Vert.x-Web applications.

You should create one handler per SockJS application using `link:../../groovydoc/io/vertx/groovy/ext/web/handler/sockjs/SockJSHandler.html#create(io.vertx.core.Vertx)[SockJSHandler.create]`.
...
The object passed into the handler is a `link:../../groovydoc/io/vertx/groovy/ext/web/handler/sockjs/SockJSSocket.html[SockJSSocket]`. This has a familiar
socket-like interface which you can read and write to similarly to a `link:../../groovydoc/io/vertx/groovy/core/net/NetSocket.html[NetSocket]` or
a `link:../../groovydoc/io/vertx/groovy/core/http/WebSocket.html[WebSocket]`. It also implements `link:../../groovydoc/io/vertx/groovy/core/streams/ReadStream.html[ReadStream]` and
`link:../../groovydoc/io/vertx/groovy/core/streams/WriteStream.html[WriteStream]` so you can pump it to and from other read and write streams.
...
terminating at at a `link:../../groovydoc/io/vertx/groovy/ext/web/handler/sockjs/SockJSHandler.html[SockJSHandler]` on the server-side.

A special SockJS socket handler is then installed on the `link:../../groovydoc/io/vertx/groovy/ext/web/handler/sockjs/SockJSHandler.html[SockJSHandler]` which
handles the SockJS data and bridges it to and from the server side event bus.

To activate the bridge you simply call
`link:../../groovydoc/io/vertx/groovy/ext/web/handler/sockjs/SockJSHandler.html#bridge(io.vertx.ext.web.handler.sockjs.BridgeOptions)[bridge]` on the
SockJS handler.
...
`link:../../vertx-bridge-common/dataobjects.html#PermittedOptions#setAddress(java.lang.String)[address]`:: This represents the exact address the message is being sent to. If you want to allow messages based on
an exact address you use this field.
`link:../../vertx-bridge-common/dataobjects.html#PermittedOptions#setAddressRegex(java.lang.String)[addressRegex]`:: This is a regular expression that will be matched against the address. If you want to allow messages
based on a regular expression you use this field. If the `address` field is specified this field will be ignored.
`link:../../vertx-bridge-common/dataobjects.html#PermittedOptions#setMatch(io.vertx.core.json.JsonObject)[match]`:: This allows you to allow messages based on their structure. Any fields in the match must exist in the
...
`link:../../groovydoc/io/vertx/groovy/ext/web/handler/sockjs/SockJSHandler.html#bridge(io.vertx.ext.web.handler.sockjs.BridgeOptions,%20io.vertx.core.Handler)[bridge]`.

Whenever an event occurs on the bridge it will be passed to the handler. The event is described by an instance of
`link:../../groovydoc/io/vertx/groovy/ext/web/handler/sockjs/BridgeEvent.html[BridgeEvent]`.
...
The event enables you to retrieve the type using `link:../../groovydoc/io/vertx/groovy/ext/web/handler/sockjs/BridgeEvent.html#type()[type]` and
inspect the raw message of the event using `link:../../groovydoc/io/vertx/groovy/ext/web/handler/sockjs/BridgeEvent.html#rawMessage()[rawMessage]`.
...
The event is also an instance of `link:../../groovydoc/io/vertx/groovy/core/Future.html[Future]`. When you are finished handling the event you can
...
sockJSHandler.bridge(options, { be ->
  if (be.type() == BridgeEventType.PUBLISH || be.type() == BridgeEventType.RECEIVE) {
    if (be.rawMessage().body == "armadillos") {
      // Reject it
      be.complete(false)
      return
    }
...
Vert.x-Web includes a handler `link:../../groovydoc/io/vertx/groovy/ext/web/handler/CSRFHandler.html[CSRFHandler]` that you can use to prevent cross site
...
----
import io.vertx.groovy.ext.web.handler.CookieHandler
import io.vertx.groovy.ext.web.handler.CSRFHandler
...
[source,groovy]
----
import io.vertx.groovy.ext.web.handler.VirtualHostHandler
